...
RUN_ID="${RUN_ID:-database-slow-incident}"
...
# A falha HTTP faz parte do experimento; registrá-la permite concluir a carga
# limitada sem esconder timeouts de transporte.
request_number=1
