...
RUN_ID="${RUN_ID:-table-lock-incident}"
...
# O lock-holder encerra sozinho após oito segundos; esta carga continua por uma
# janela curta para capturar tanto requisições bloqueadas quanto a recuperação.
request_number=1
