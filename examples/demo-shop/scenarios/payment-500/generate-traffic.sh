...
RUN_ID="${RUN_ID:-payment-500-incident}"
...
# O código 500 é resultado esperado e por isso não usamos --fail; falhas de
# transporte continuam visíveis na saída como transport-error.
request_number=1
