...
RUN_ID="${RUN_ID:-retry-storm-incident}"
...
# Uma requisição externa gera quatro tentativas internas no mesmo trace; oito
# traces mantêm a amostra acima do mínimo sem produzir carga ilimitada.
request_number=1
