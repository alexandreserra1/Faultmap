...
| `checkout-incident-sample.json` | Janela representativa de incidente entre `2025-12-01T10:01:00Z` e `10:02:00Z`. | 20 traces e 40 spans: 8 respostas HTTP `500` (40%), 6 timeouts PostgreSQL (30%), latência HTTP entre 800 e 2.500 ms e p95 de 2.500 ms. |
